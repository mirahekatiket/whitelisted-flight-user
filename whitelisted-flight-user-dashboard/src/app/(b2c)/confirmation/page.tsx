  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#E8F4FD] to-white">
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-12">
        ...
        {/* Warning Banner - Important for the prototype */}
        <div className="bg-gradient-to-r from-amber-500 to-orange-500 rounded-2xl p-6 mb-6 text-white">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-bold text-lg mb-1">⚠️ STAGING ENVIRONMENT</h3>
              <p className="text-white/90 text-sm">
                This is a <strong>PROTOTYPE</strong> for QA testing purposes.
                <br />
                Real booking was <strong>NOT</strong> created. This environment
                uses staging/mock data.
              </p>
            </div>
          </div>
        </div>
